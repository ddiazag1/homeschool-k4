...
1: {
  ...
  history: [
    ...
    {u:"The Return of Assyria", src:"SOTW Ch 18 — Ashurbanipal, the Library of Nineveh", l:[1013]},
    {u:"Greece Gets Civilized Again", src:"SOTW Ch 19 — alphabet, Homer, first Olympics", l:[49]},
    {u:"Sparta and Athens", src:"SOTW Ch 20 — two ways to live; Draco and Solon", l:[1014]},
    {u:"The Greek Gods", src:"SOTW Ch 21 — the Golden Apple", l:[1015]},
    {u:"The Rise of Rome", src:"SOTW Ch 22 — Romulus and Remus", l:[50]},
    {u:"Babylon Takes Over Again", src:"SOTW Ch 23 — Nebuchadnezzar, Hanging Gardens", l:[1016]},
    {u:"The Medes and the Persians", src:"SOTW Ch 24 — Cyrus the Great", l:[53]},
    {u:"The Aryans of India", src:"SOTW Ch 25 — the Ganges, castes, Siddhartha", l:[1017], s:1},
    {u:"Writing, Fighting and Thinking in China", src:"SOTW Ch 26 — calligraphy, Confucius", l:[1018]},
    {u:"The Wars of the Greeks", src:"SOTW Ch 27 — Persia, then each other", l:[1019]},
  ...
  science: [
    ...
    {u:"Air Is a Substance; the Atmosphere", src:"BFSU A-3", l:[2006]},
    {u:"Life Cycles", src:"BFSU B-4", l:[7]},
    {u:"Energy II: Kinetic and Potential", src:"BFSU C-3", l:[2010]},
    {u:"Reading and Drawing Maps", src:"BFSU D-3", l:[2014]},
    {u:"Matter I: Its Particulate Nature", src:"BFSU A-4", l:[22]},
    {u:"Why Plants and Animals Live Where They Do", src:"BFSU B-4A", l:[6]},
    {u:"Energy and Force", src:"BFSU C-3A", l:[2011]},
    {u:"North, East, South, and West", src:"BFSU D-3A", l:[2015]},
    {u:"Distinguishing Materials", src:"BFSU A-5", l:[2007]},
    {u:"What Is a Species?", src:"BFSU B-4B", l:[2009]},
    {u:"Energy III: Matter versus Energy", src:"BFSU C-4", l:[2012]},
    ...
    {u:"Inertia", src:"BFSU C-5", l:[2013]},
    {u:"Time and the Earth's Turning", src:"BFSU D-5", l:[]},
    {u:"Matter II: Air Pressure and Vacuums", src:"BFSU A-6", l:[2008]},
